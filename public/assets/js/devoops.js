...
$(document).ready(function () {
	...
	$('.dropdown:has(li:has(a.active)) > ul').css("display", "none");
	$('.dropdown:has(li) > a').removeClass('active-parent active');
	var current_url      = window.location.href;
	var origin   = window.location.origin;
	current_url = current_url.replace(origin+'/musok_vat/','');
	//alert(current_url);
	$("a[href='"+current_url+"']").addClass('active-parent active');
