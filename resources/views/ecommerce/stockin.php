...
<br/><br/>
    ...
    <form action="<?php echo URL?>ecommerce/savestock" method="post" enctype="multipart/form-data">
        ...
        Quantity :<br>
        <input type="text" name="quantity" value="<?php echo old($inputs,'quantity');?>"> <br>
        <?php if(isset($errors['quantity'])):?>
            <span class="text-danger"><?php echo $errors['quantity'][0]; ?></span>
        <?php endif;?> <br />
